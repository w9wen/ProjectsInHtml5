$(function () {
  ...
  var template =
    '<div class="preview"><span class="imageHolder><img/></span><div class="progressHolder"><div class="progress"></div></div></div>';
  ...
  function createImage(file) {
    ...
    reader.onload = function (e) {
      image.attr("scr", e.target.result);
    };
